...
export class StageModel {
  ...
  refresh() {
    ...
    this.triggers = Array.from(
      ...
      .map((element, index) => {
        const blockElement = element.parentElement;
        ...
        const isUsed =
          ...
          blockElement.dataset.collapseState === "collapsing";
  ...
  activateTrigger(triggerId) {
    ...
    const { x, y } = this.getCollapseOffset(trigger);
    ...
    trigger.blockElement.dataset.collider = "disabled";
    trigger.blockElement.dataset.collapseState = "collapsing";
  ...
  getCollapseOffset(trigger) {
    ...
    const horizontalDistance =
      trigger.blockRect.width + trigger.rect.width + extraDistance;
    const verticalDistance =
      trigger.blockRect.height + trigger.rect.height + extraDistance;
